...
/**
  ...
  * during instancing (see raycer::Instance).
  * 
...
public:
  ...
  /**
    ...
    */
  inline explicit HitPoint(const raycer::Primitive* primitive, double distance, const Vector4d& point, const Vector3d& normal)
  ...
  /**
    ...
    */
  inline const raycer::Primitive* primitive() const {
    return m_primitive;
  }
  ...
  /**
    ...
    */
  inline void setPrimitive(const raycer::Primitive* primitive) {
    m_primitive = primitive;
  }
...
private:
  const raycer::Primitive* m_primitive;
  double m_distance;
  Vector4d m_point;
  Vector3d m_normal;
};
