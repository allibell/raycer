...
private:
  std::shared_ptr<raycer::Primitive> closedCylinder(double radius, double height) const;
  std::shared_ptr<raycer::Primitive> ring(double outerRadius, double innerRadius, double height) const;
